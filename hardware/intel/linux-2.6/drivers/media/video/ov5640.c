...
static int ov5640_res2size(unsigned int res, int *h_size, int *v_size)
{
	...
	case OV5640_RES_480P:
		...
		break;
	case OV5640_RES_1M:
		hsize = OV5640_RES_1M_SIZE_H;
		vsize = OV5640_RES_1M_SIZE_V;
		break;
			      ...
			      struct v4l2_mbus_framefmt *fmt)
{
	...
	case OV5640_RES_480P:
		...
		break;
	case OV5640_RES_1M:
		ret = ov5640_write_reg_array(c, ov5640_1M_init);
		break;
	case OV5640_RES_720P:
	...
	return ov5640_write_reg(c, MISENSOR_8BIT,
					OV5640_REG_FOCUS_MODE,
