...
#define SEQ_CMD_GOTO_PREVIEW	0x0001
#define SEQ_CMD_GOTO_CAPTURE	0x0002
#define SEQ_CMD_REFRESH_MODE	0x0006
#define SEQ_CMD_REFRESH		0x0005
#define MT9D113_VAR_SEQ_STATE	0xa104

#define MT9D113_VAR_SEQ_CAP_MODE	0xa115
#define SEQ_CMD_CAP_MODE_VIDEO	0x2

#define MT9D113_VAR_COL_EFF_A	0x2759
#define MT9D113_VAR_COL_EFF_B	0x275b
...
struct mt9d113_device {
	...
	int res_contextA;	/* res setting for contextA */
	int res_contextB;	/* res setting for contextB */
};
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_qcif_30_init_A[] = {
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_cif_30_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_qvga_30_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_vga_30_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
static struct misensor_reg const mt9d113_vga_wide_29_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
	{MISENSOR_16BIT, 0x990, 0x0280},/*      = 640*/
	{MISENSOR_16BIT, 0x98c, 0x2705},/*Output Height (a)*/
...
; vblank: 3.6ms
 */
static struct misensor_reg const mt9d113_720p_29_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_svga_30_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4.4ms
 */
static struct misensor_reg const mt9d113_1m_15_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4.4ms
 */
static struct misensor_reg const mt9d113_2m_15_init_A[] = {
	{MISENSOR_16BIT, 0x98c, 0x2703},/*Output Width (a)*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_qcif_30_init_B[] = {
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_cif_30_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0160},/*      = 352*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x0120},/*      = 288*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_qvga_30_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0140},/*      = 320*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x00f0},/*      = 240*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_vga_30_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0280},/*      = 640*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x01e0},/*      = 480*/
...
static struct misensor_reg const mt9d113_vga_wide_29_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0280},/*      = 640*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x0168},/*      = 360*/
...
/*
 * Context B setting for 1280x720
; Max Frame Time: 34.4828 msec
; Max Frame Clocks: 1462068.9 clocks (42.400 MHz)
; Pixel Clock: divided by 1
; Skip Mode: 1x cols, 1x rows, Bin Mode: No
...
; vblank: 3.6ms
 */
static struct misensor_reg const mt9d113_720p_29_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0500},/*      = 1280*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x02d0},/*      = 720*/
...
; vblank: 4ms
 */
static struct misensor_reg const mt9d113_svga_30_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0320},/*      = 800*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x0258},/*      = 600*/
...
/*
 * Context B setting for 1024x768
; Max Frame Time: 66.8896 msec
; Max Frame Clocks: 2836120.4 clocks (42.400 MHz)
; Pixel Clock: divided by 1
; Skip Mode: 1x cols, 1x rows, Bin Mode: No
...
; vblank: 4.4ms
 */
static struct misensor_reg const mt9d113_1m_15_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0400},/*      = 1024*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x0300},/*      = 768*/
...
/*
 * Context B setting for 1600x1200
; Max Frame Time: 66.8896 msec
; Max Frame Clocks: 2836120.4 clocks (42.400 MHz)
; Pixel Clock: divided by 1
; Skip Mode: 1x cols, 1x rows, Bin Mode: No
...
; vblank: 4.4ms
 */
static struct misensor_reg const mt9d113_2m_15_init_B[] = {
	{MISENSOR_16BIT, 0x98c, 0x2707},/*Output Width (b)*/
	{MISENSOR_16BIT, 0x990, 0x0640},/*      = 1600*/
	{MISENSOR_16BIT, 0x98c, 0x2709},/*Output Height (b)*/
	{MISENSOR_16BIT, 0x990, 0x04b0},/*      = 1200*/
...
static struct misensor_reg const mt9d113_lsc_95[] = {
	...
	{MISENSOR_16BIT, 0x364e, 0x0690},
	{MISENSOR_16BIT, 0x3650, 0x8dec},
	{MISENSOR_16BIT, 0x3652, 0x3252},
	{MISENSOR_16BIT, 0x3654, 0xec6b},
	{MISENSOR_16BIT, 0x3656, 0xa392},
	{MISENSOR_16BIT, 0x3658, 0x0130},
	{MISENSOR_16BIT, 0x365a, 0xf589},
	{MISENSOR_16BIT, 0x365c, 0x40b2},
	{MISENSOR_16BIT, 0x365e, 0xed8b},
	{MISENSOR_16BIT, 0x3660, 0xcfad},
	{MISENSOR_16BIT, 0x3662, 0x0170},
	{MISENSOR_16BIT, 0x3664, 0x5a68},
	{MISENSOR_16BIT, 0x3666, 0x07d2},
	{MISENSOR_16BIT, 0x3668, 0x1d0e},
	{MISENSOR_16BIT, 0x366a, 0x3ed1},
	{MISENSOR_16BIT, 0x366c, 0x00d0},
	{MISENSOR_16BIT, 0x366e, 0x9f6c},
	{MISENSOR_16BIT, 0x3670, 0x28f2},
	{MISENSOR_16BIT, 0x3672, 0x80ec},
	{MISENSOR_16BIT, 0x3674, 0xa672},
	{MISENSOR_16BIT, 0x3676, 0x666c},
	{MISENSOR_16BIT, 0x3678, 0x99af},
	{MISENSOR_16BIT, 0x367a, 0xd96d},
	{MISENSOR_16BIT, 0x367c, 0x03cf},
	{MISENSOR_16BIT, 0x367e, 0xa6d2},
	{MISENSOR_16BIT, 0x3680, 0x154d},
	{MISENSOR_16BIT, 0x3682, 0x2bef},
	{MISENSOR_16BIT, 0x3684, 0x7071},
	{MISENSOR_16BIT, 0x3686, 0xc9b2},
	{MISENSOR_16BIT, 0x3688, 0xedf4},
	{MISENSOR_16BIT, 0x368a, 0x370c},
	{MISENSOR_16BIT, 0x368c, 0x8a8e},
	{MISENSOR_16BIT, 0x368e, 0x4391},
	{MISENSOR_16BIT, 0x3690, 0xad30},
	{MISENSOR_16BIT, 0x3692, 0xd0b4},
	{MISENSOR_16BIT, 0x3694, 0x278d},
	{MISENSOR_16BIT, 0x3696, 0x5f2f},
	{MISENSOR_16BIT, 0x3698, 0xca8f},
	{MISENSOR_16BIT, 0x369a, 0xe151},
	{MISENSOR_16BIT, 0x369c, 0x91d2},
	{MISENSOR_16BIT, 0x369e, 0x7872},
	{MISENSOR_16BIT, 0x36a0, 0x1171},
	{MISENSOR_16BIT, 0x36a2, 0x0196},
	{MISENSOR_16BIT, 0x36a4, 0xb075},
	{MISENSOR_16BIT, 0x36a6, 0xfc38},
	{MISENSOR_16BIT, 0x36a8, 0x6f52},
	{MISENSOR_16BIT, 0x36aa, 0xc8ad},
	{MISENSOR_16BIT, 0x36ac, 0x2536},
	{MISENSOR_16BIT, 0x36ae, 0x5df1},
	{MISENSOR_16BIT, 0x36b0, 0x9a59},
	{MISENSOR_16BIT, 0x36b2, 0x53d2},
	{MISENSOR_16BIT, 0x36b4, 0x8550},
	{MISENSOR_16BIT, 0x36b6, 0x7ff5},
	{MISENSOR_16BIT, 0x36b8, 0x2b32},
	{MISENSOR_16BIT, 0x36ba, 0xe698},
	{MISENSOR_16BIT, 0x36bc, 0x78b2},
	{MISENSOR_16BIT, 0x36be, 0x52f0},
	{MISENSOR_16BIT, 0x36c0, 0x7775},
	{MISENSOR_16BIT, 0x36c2, 0x9655},
	{MISENSOR_16BIT, 0x36c4, 0xf4b8},
	{MISENSOR_16BIT, 0x36c6, 0x104f},
	{MISENSOR_16BIT, 0x36c8, 0x90f0},
	{MISENSOR_16BIT, 0x36ca, 0x0e74},
	{MISENSOR_16BIT, 0x36cc, 0x0834},
	{MISENSOR_16BIT, 0x36ce, 0x8a13},
	{MISENSOR_16BIT, 0x36d0, 0x164f},
	{MISENSOR_16BIT, 0x36d2, 0xf891},
	{MISENSOR_16BIT, 0x36d4, 0x81b6},
	{MISENSOR_16BIT, 0x36d6, 0x4bf5},
	{MISENSOR_16BIT, 0x36d8, 0x6798},
	{MISENSOR_16BIT, 0x36da, 0x1410},
	{MISENSOR_16BIT, 0x36dc, 0x03ae},
	{MISENSOR_16BIT, 0x36de, 0xdab5},
	{MISENSOR_16BIT, 0x36e0, 0x7e72},
	{MISENSOR_16BIT, 0x36e2, 0x53b8},
	{MISENSOR_16BIT, 0x36e4, 0x1790},
	{MISENSOR_16BIT, 0x36e6, 0xbbb0},
	{MISENSOR_16BIT, 0x36e8, 0x6232},
	{MISENSOR_16BIT, 0x36ea, 0xa36f},
	{MISENSOR_16BIT, 0x36ec, 0x0fd5},
	{MISENSOR_16BIT, 0x36ee, 0xacd3},
	{MISENSOR_16BIT, 0x36f0, 0xc914},
	{MISENSOR_16BIT, 0x36f2, 0xd699},
	{MISENSOR_16BIT, 0x36f4, 0x6618},
	{MISENSOR_16BIT, 0x36f6, 0x25fc},
	{MISENSOR_16BIT, 0x36f8, 0x1073},
	{MISENSOR_16BIT, 0x36fa, 0x7691},
	{MISENSOR_16BIT, 0x36fc, 0xfd39},
	{MISENSOR_16BIT, 0x36fe, 0xc576},
	{MISENSOR_16BIT, 0x3700, 0x37fc},
	{MISENSOR_16BIT, 0x3702, 0x0bd2},
	{MISENSOR_16BIT, 0x3704, 0x7f53},
	{MISENSOR_16BIT, 0x3706, 0xb799},
	{MISENSOR_16BIT, 0x3708, 0xab57},
	{MISENSOR_16BIT, 0x370a, 0x065c},
	{MISENSOR_16BIT, 0x370c, 0xb533},
	{MISENSOR_16BIT, 0x370e, 0x8fb4},
	{MISENSOR_16BIT, 0x3710, 0xd299},
	{MISENSOR_16BIT, 0x3712, 0x4878},
	{MISENSOR_16BIT, 0x3714, 0x25fc},
	{MISENSOR_16BIT, 0x3644, 0x0344},
	{MISENSOR_16BIT, 0x3642, 0x024c},
