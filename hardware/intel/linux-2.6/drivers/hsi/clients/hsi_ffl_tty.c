...
#define T_ON1_UDELAY		60	/* ON1 pulse delay: 60 us */
#define T_BBRST_MDELAY		1	/* BBRST pulse delay: 1 ms */
#define T_AFTER_MSLEEP		200	/* Post seq. sleep duration: 200 ms */
