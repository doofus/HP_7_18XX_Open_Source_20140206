...
void *ft5316_platform_data(void *info)
{
	static struct ft5x06_info ft5316_pdata;

	//ft5316_pdata.numtouch       = 10;
	//ft5316_pdata.maxx          = 540;
	//ft5316_pdata.maxy          = 960;
	//ft5316_pdata.orientation    = MXT_MSGB_T9_ORIENT_HORZ_FLIP;
	ft5316_pdata.power_ic_flag = 1,
	ft5316_pdata.rst_gpio = get_gpio_by_name("ts_rst");
	ft5316_pdata.irq_gpio= get_gpio_by_name("ts_int");
	ft5316_pdata.init_virtual_key=ft5306_init_virtual_key;
	pr_info("ft5316_platform_data()\n");
...
void *ft5316_platform_data(void *info)
{
	static struct ft5306_touch_platform_data ft5316_pdata;

	//ft5316_pdata.numtouch       = 10;
	ft5316_pdata.maxx          = 1024;
	ft5316_pdata.maxy          = 600;
	//ft5316_pdata.orientation    = MXT_MSGB_T9_ORIENT_HORZ_FLIP;
	ft5316_pdata.reset          = get_gpio_by_name("CTP_AP_WAKE");
	ft5316_pdata.irq            = get_gpio_by_name("ts_int");
	pr_info("ft5316_platform_data()\n");
